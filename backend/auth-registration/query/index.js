const query = {
    ...
    sim_caregiver_query: "select c.id as caregiver_id, m.id as member_id, m.fname, m.lname, m.email FROM member m INNER JOIN caregiver c on c.email = m.email where m.id = ? ",
